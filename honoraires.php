...
<section class="container ms-4 row w-75">
    ...
    <p><h2>Comment sont définis les honoraires ?</h2></p>
    <div class="m-4 p-2"></div>
        <p>Première consultation : </p>
        <p><strong>En principe, la première consultation reste payante.</strong></p>
        <p><strong>Tarif indicatif : entre 50 et 100 € HT pour un rendez-vous de 30 min à 1 h</strong></p>
        <p class="mb-4 pb-4">Lorsque la consultation est tarifée, le prix est toujours fixé à l'avance, sans surprise. 
    ...
    <div class="text-md-start mx-4 my-4">
    <p><h2>Qu’est ce que l’assurance de protection juridique ?</h2></p>
    <div class="m-4 p-2"></div>
    <p class="mb-4 pb-4">
        ...
        Lien d’information sur l’assurance: <a href="https://www.service-public.fr/particuliers/vosdroits/F3049">
        https://www.service-public.fr/particuliers/vosdroits/F3049</a>
    </p>
    </div>
    <div class="text-md-start mx-4 my-4">
    <p><h2 class="titre">Qu’est ce que l’aide juridique ?</h2></p>
    <div class="m-4 p-2"></div>
    <p class="mb-4 pb-4">
        ...
        Lien vers le simulateur de l’aide: <a href="https://www.service-public.fr/particuliers/vosdroits/F18074">
        https://www.service-public.fr/particuliers/vosdroits/F18074</a>
    </p>
    </div>
    <div class="text-md-start mx-4 my-4">
    <p><h2>Comment je peux vous aider ?</h2></p>
    <div class="m-4 p-2"></div>
    <p class="mb-4 pb-4">
